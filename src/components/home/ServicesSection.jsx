    ...
    <section id="services" className="py-16 sm:py-20 bg-brand-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="inline-block text-brand-primary text-sm font-semibold tracking-wider uppercase mb-2">Our Services</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {services.map((service) => {
            ...
            return (
              <Card key={service.id} dark glow className="group hover:scale-[1.02] cursor-pointer">
